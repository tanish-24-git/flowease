...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-green-100 to-pink-100 py-12 mt-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Brand Info */}
          <div>
            <h3 className="text-xl font-bold text-pink-300 mb-4">FLOWEASE</h3>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold text-green-700 mb-4">Contact Us</h4>
            <ul className="space-y-3">
              <li className="flex items-center">
                <Mail size={20} className="text-green-500 mr-2" />
                <a href="mailto:Flowease25@gmail.com" className="text-gray-600 hover:text-green-600 transition-colors">
                  Flowease25@gmail.com
                </a>
              </li>
              <li className="flex items-center">
                <Phone size={20} className="text-green-500 mr-2" />
                <a href="tel:+919529443859" className="text-gray-600 hover:text-green-600 transition-colors">
                  +91 95294 43859
                </a>
              </li>
              <li className="flex items-center">
                <Instagram size={20} className="text-green-500 mr-2" />
                <a
